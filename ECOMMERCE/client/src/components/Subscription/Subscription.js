...
export default function Subscription() {
  return (
   <>
    <div className='my90 d-flex flex-column bg-offwhite'>
      ...
      <h3 className="fw-bold">WANT $ <span className='fs-2'>10</span> OFF ?</h3>
        ...
        <div class="d-flex justify-center mx-auto">
          <input
            class="w-200 me-2 border-top-0 border-start-0 border-end-0 border-bottom border border-secondary bg-offwhite"
            type="search"
